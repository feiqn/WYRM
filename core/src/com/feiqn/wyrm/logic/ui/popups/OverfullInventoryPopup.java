...
public class OverfullInventoryPopup extends PopupMenu {
    ...
    public OverfullInventoryPopup(WYRMGame game, Unit unit, Item newItem) {
        ...
        final Label item1Label = new Label("" + inventory.item1.name, game.activeBattleScreen.menuLabelStyle);
        ...
        final Label item2Label = new Label("" + inventory.item2.name, game.activeBattleScreen.menuLabelStyle);
        item2Label.setFontScale(1.5f);
        item2Label.setPosition(item1Label.getX(), item1Label.getY() - item2Label.getHeight() * 3);
        addActor(item2Label);

        final Label item3Label = new Label("" + inventory.item3.name, game.activeBattleScreen.menuLabelStyle);
        item3Label.setFontScale(1.5f);
        item3Label.setPosition(item1Label.getX(), item2Label.getY() - item3Label.getHeight() * 3);
        addActor(item3Label);

        final Label item4Label = new Label("" + inventory.item4.name, game.activeBattleScreen.menuLabelStyle);
        item4Label.setFontScale(1.5f);
        item4Label.setPosition(item1Label.getX(), item3Label.getY() - item4Label.getHeight() * 3);
        addActor(item4Label);

        final Label item5Label = new Label("" + inventory.item5.name, game.activeBattleScreen.menuLabelStyle);
        item5Label.setFontScale(1.5f);
        item5Label.setPosition(item1Label.getX(), item4Label.getY() - item5Label.getHeight() * 3);
        addActor(item5Label);

        final Label newItemLabel = new Label("" + newItem.name, game.activeBattleScreen.menuLabelStyle);
