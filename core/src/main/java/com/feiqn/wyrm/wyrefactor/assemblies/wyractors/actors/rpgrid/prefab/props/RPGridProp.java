package com.feiqn.wyrm.wyrefactor.assemblies.wyractors.actors.rpgrid.prefab.props;
...
public abstract class RPGridProp extends RPGridActor {
    ...
    public RPGridProp(RPGridMetaHandler metaHandler, PropType propType, int interactRange) {
        this(metaHandler, propType, interactRange, (Drawable)null);
    }
    public RPGridProp(RPGridMetaHandler metaHandler, PropType propType, int interactRange, NinePatch patch) {
        this(metaHandler, propType, interactRange, new NinePatchDrawable(patch), Scaling.stretch, Align.center);
    }
    public RPGridProp(RPGridMetaHandler metaHandler, PropType propType, int interactRange, TextureRegion region) {
        this(metaHandler, propType, interactRange, new TextureRegionDrawable(region), Scaling.stretch, Align.center);
    }
    public RPGridProp(RPGridMetaHandler metaHandler, PropType propType, int interactRange, Texture texture) {
        this(metaHandler, propType, interactRange, new TextureRegionDrawable(new TextureRegion(texture)));
    }
    public RPGridProp(RPGridMetaHandler metaHandler, PropType propType, int interactRange, Skin skin, String drawableName) {
        this(metaHandler, propType, interactRange, skin.getDrawable(drawableName), Scaling.stretch, Align.center);
    }
    public RPGridProp(RPGridMetaHandler metaHandler, PropType propType, int interactRange, Drawable drawable) {
        this(metaHandler, propType, interactRange, drawable, Scaling.stretch, Align.center);
    }
    public RPGridProp(RPGridMetaHandler metaHandler, PropType propType, int interactRange, Drawable drawable, Scaling scaling) {
        this(metaHandler, propType, interactRange, drawable, scaling, Align.center);
    }
    public RPGridProp(RPGridMetaHandler metaHandler, PropType propType, int interactRange, Drawable drawable, Scaling scaling, int align) {
