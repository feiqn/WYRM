...
public class GHUD_UnifiedInfo extends Window {
    ...
    public GHUD_UnifiedInfo(Skin skin) {
        super("", skin);
        this.skin = skin;
...
//                }
    ...
    public void updateActorContext(WyrActor actor) {
    ...
    private final static class HealthBar extends ProgressBar {
        ...
        private final WyrActor tracking;

        public HealthBar(Skin skin, WyrActor actor) {
