...
import static com.feiqn.wyrm.wyrefactor.helpers.interfaces.wyr.Wyr.ShaderState.HIGHLIGHT;

public final class RPGridPriorityHandler extends WyrPriorityHandler {

    private RPGridActor focusedActor = null;

    public RPGridPriorityHandler(RPGridMetaHandler metaHandler) {
        super(metaHandler);
    }
