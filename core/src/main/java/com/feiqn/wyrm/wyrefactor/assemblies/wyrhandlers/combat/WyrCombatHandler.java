...
//
//                handlers.cutscenes().checkCombatEndTriggers(attacker.getCharacterID(), attacker.getTeamAlignment(), defender.getCharacterID(), defender.getTeamAlignment());
//
...
//        };
//
//        handlers.cutscenes().checkCombatStartTriggers(attacker.getCharacterID(), attacker.getTeamAlignment(), defender.getCharacterID(), defender.getTeamAlignment());
//
