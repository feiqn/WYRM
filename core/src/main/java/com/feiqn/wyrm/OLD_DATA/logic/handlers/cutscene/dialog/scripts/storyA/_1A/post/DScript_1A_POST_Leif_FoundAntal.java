...
//        set(OLD_CharacterExpression.ANTAL_EXHAUSTED, "This armor weighs me down so much, it seems I'm the last one to make it out of the city.");
...
//        set(OLD_CharacterExpression.ANTAL_CURIOUS, "I've... never seen a horse like that up close. Only in pictures, and as far off specs among the mountaintop clouds.");
