...
//import com.feiqn.wyrm.wyrefactor.assemblies.wyrhandlers.cutscenes.ProgressiveLabel;
...
//
////    public CutscenePlayer(WYRMGame game) {
...
//                return game.activeOLDGridScreen.getInputMode() != OLD_GridScreen.OLD_InputMode.LOCKED;
//            }
//
//            @Override
...
//            @Override
//            public void run() {
//                game.activeOLDGridScreen.endCutscene();
//            }
//        }, .9f);
//
//    }
...
//                game.activeOLDGridScreen.setInputMode(OLD_GridScreen.OLD_InputMode.LOCKED);
//                Timer.schedule(new Timer.Task() {
//                    @Override
//                    public void run() {
...
//                       game.OLD_TransitionToScreen(choreography.getScreenForTransition());
////                    }
////                }, 5);
//                break;
//
...
//            ags.setInputMode(OLD_GridScreen.OLD_InputMode.CUTSCENE);
