...
//import com.feiqn.wyrm.wyrefactor.helpers.interfaces.Wyr.HorizontalPosition;
//
...
//
//        set(OLD_CharacterExpression.GENERIC_SOLDIER, "Damned Northerners!", HorizontalPosition.RIGHT, true);
//        lastFrame().setFocusedName("Danial");
//
//        set(OLD_CharacterExpression.GENERIC_SOLDIER, "My wounds are deep, but even if it costs me my life, I will protect my home!", HorizontalPosition.RIGHT, true);
//        lastFrame().setFocusedName("Danial");
//
//        set(OLD_CharacterExpression.GENERIC_SOLDIER, "I'll man this ballista until my dying breath, and drag you all to hell with me!", HorizontalPosition.RIGHT, true);
//        lastFrame().setFocusedName("Danial");
//
//        set(OLD_CharacterExpression.GENERIC_SOLDIER, "Take this!", HorizontalPosition.RIGHT, true);
//        lastFrame().setFocusedName("Danial");
//
...
//
//        set(OLD_CharacterExpression.LEIF_SURPRISED, "Holy shit!", HorizontalPosition.RIGHT, true);
//
//        set(OLD_CharacterExpression.LEIF_SURPRISED, "That guy just got obliterated!", HorizontalPosition.RIGHT, true);
//
//        set(OLD_CharacterExpression.LEIF_DETERMINED, "I've got to get out of here!", HorizontalPosition.RIGHT, true);
//    }
//}
