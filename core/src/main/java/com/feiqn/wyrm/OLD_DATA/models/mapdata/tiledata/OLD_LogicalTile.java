package com.feiqn.wyrm.OLD_DATA.models.mapdata.tiledata;
...
public class OLD_LogicalTile extends Image {
    ...
    // --UNITS--
    protected OLD_SimpleUnit occupyingUnit;
    ...
    protected final OLD_LogicalTile self = this;
...
//        game.activeBattleScreen.rootGroup.addActor(highlightImage);
    ...
    public void occupy(OLD_SimpleUnit unit) {
        occupyingUnit = unit;
        isOccupied = true;
    }
    ...
    public OLD_SimpleUnit getOccupyingUnit() {return  occupyingUnit;}
