...
import com.feiqn.wyrm.OLD_DATA.logic.handlers.cutscene.dialog.scripts.storyA._1A.post.DScript_1A_POST_Leif_FoundAntal;
...
public class OLDGridScreen_CUTSCENE_Leif_FoundAntal extends OLD_GridScreen {

    // Leif catches up with Antal after helping him escape in 1A.

    public OLDGridScreen_CUTSCENE_Leif_FoundAntal(WYRMGame game) {
        super(game);
    }
